...
<head>
    ...
    <style>
      @import url('https://fonts.googleapis.com/css2?family=Handlee&display=swap');
       ...
       form > .btn-primary, #InputEmail1, #InputPassword1 {
           width: 100%;
           min-height: 48px;
           height: 100%;
       }
...
<body>
    ...
    <nav class="nav-pills">
        ...
        <hr>
        <form>
            <h3 class="display-5" id="">Login</h3>
            <hr>
            ...
            <label id="sg-label" for="signup">Don't have an account? <a href="../signup"><u>Sign Up</u></a></label>
          </form>
